...
- [Landing Screen](http://localhost:3000)
- [Home Screen](http://localhost:3000/dashboard)
- [Weather Screen](http://localhost:3000/weather/forecast/San%20Mateo)
